...
O painel foi modelado estrategicamente para responder às seguintes perguntas de negócio:
* **Pergunta 1:** Qual o valor total vendido?
* **Pergunta 2:** Quantas vendas foram realizadas por categoria de produto?
* **Pergunta 3:** Quantas vendas foram realizadas por país considerando a prioridade de entrega?
* **Pergunta 4:** Qual foi a média de desconto nas vendas por subcategoria de produto?
* **Pergunta 5:** Quais países tiveram maior média de valor de venda? (Demonstrado no mapa interativo).

**Recurso de Filtros:** O dashboard dá ao usuário a possibilidade total de segmentar e filtrar os dados por **Ano**, por **Segmento** e por **País**.
